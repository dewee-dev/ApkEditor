 ...
 */
package com.mcal.apkeditor.ui.main.base;
...
import com.mcal.apkeditor.utils.BitmapRepeater;
...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void setDefaultActionBar() {
        ...
        if (actionBar != null) {
            @SuppressLint("InflateParams") RelativeLayout actionBarCustomView = (RelativeLayout) LayoutInflater.from(this).inflate(R.layout.toolbar, null);
    ...
    protected void setActionBarButtonCloseRight() {
        View buttonClose = getLayoutInflater().inflate(R.layout.button_close, null);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.window_background);
